...
if ( ! empty( $banners ) ) : ?>
    <section id="main-carousel">
        <div id="banners" class="main-carousel">
			<?php foreach ( $banners as $key => $banner ) : ?>
                <div class="carousel-item"
                     data-thumbnail="<?php echo isset( $banner['image_mini'] ) ? $banner['image_mini']['sizes']['thumbnail'] : '' ?>">
                    <img src="<?php echo $banner['image']['url'] ?>" alt="">
                    <div class="carousel-item__read-more">
						<?php if ( ! empty( $banner['link'] ) ) : ?>
                            <a href="<?php echo $banner['link'] ?>"
                               target="_blank"
                            ><?php echo __( 'Read more', 'richtime' ); ?></a>
						<?php endif ?>
                    </div>
                </div>
			<?php endforeach; ?>
        ...
        <div class="carousel-nav">
            <div class=""><img src=""
                               alt=""></div>
            <div class="banners_next"><img src=""
                                           alt=""></div>
        </div>
    </section>
<?php endif ?>
...
<div class="container">
<div class="row">
<h2 class="title">Наши бренды</h2>
<div class="row products-row">
<?php echo do_shortcode('[elementor-template id="2558"]'); ?>
</div>
</div>
</div>
</div>
