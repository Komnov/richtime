<?php if ( ! empty( $result ) ) : ?>
	<form method="GET" action="">
		<div class="richtime-filter__wrapper">
			<ul class="richtime-filter-nav nav nav-tabs" id="myTab" role="tablist">
				<?php $filter_titles = array_keys( $result ); ?>
				<?php if ( ! empty( $filter_titles ) ) : ?>
					<?php foreach ( $filter_titles as $i => $title ) : ?>
						<li class="richtime-filter-nav__item nav-item" role="presentation">
			...
			<div class="clear-filter">
				<button id="clear-filter" type="button"><?php _e( 'Clear filter', 'richtime' ) ?></button>
			</div>
		</div>
		<div class="richtime-filter-content tab-content">
			<?php foreach ( $result as $key => $section ) : ?>
				<div class="richtime-filter-content__tab tab-pane" id="<?php echo $key ?>" role="tabpanel"
					...
					<div class="richtime-filter__submit">
