...
* Social Login from 24 Social Networks - Facebook, Google, Linkedin, Twitter, Vkontakte, Line, Windows Live (Microsoft), Yahoo, WordPress, Dribbble, Kakao, Spotify, Github, Twitch, Instagram, Steam, Dropbox, Foursquare, Disqus, Reddit, Stack Overflow, Discord, Mail.ru and Amazon
...
== Changelog ==
= 7.13.35 [24 May 2022] =
* [Bugfix] Facebook login was not working since the previous update
...
* [Bugfix] Facebook checkbox in the Select Sharing Services option in the Standard Interface and Floating Interface sections were not working
* [Bugfix] Bottom and Right counter positions were not working
* [Bugfix] Clicking the social share and social media follow icons was creating a white background behind those
* [New] Added an option to change the background of Instagram to the multi-colored one
...
= 7.13.27 [25 February 2022] =
* [New] Added Gettr and Gab social share and social media follow icons
* [Improvement] Twitch social login now uses the Helix API
* [Improvement] Extra CSS files will not be loaded anymore if you change the logo color of icons
* [Improvement] Updated the Facebook JS SDK being used throughout the plugin to the latest version 13.0
...
* [Bugfix] "Hide like buttons on mobile devices" option in the Floating Interface section at the Like Buttons configuration page was not working
...
= 7.13.2 [6 October 2020] =
[Bugfix] Signup referral myCRED points were being rewarded twice via Social Login
[Improvement] Removed @charset "utf-8"; from the beginning of the CSS files being loaded at the front-end

= 7.13.1 [2 October 2020] =
[New] Added Spotify, Github, Kakao and Dribbble in the social login networks
...
[Improvement] Improved social account linking interface
<a href="https://blog.heateor.com/super-socializer-now-supports-spotify/" target="_blank">More details on What's new</a>
...
[Bugfix] Updated Facebook SDK to latest version 7.0
[Bugfix] Post-login redirection at same page was not working for Line, Microsoft, Google and Instagram login
...
* [New] Added option to customize the title displayed above the social account linking interface (Super Socializer > Social Login > Advanced Configuration > Social Account Linking Options)
* [Bugfix] Line Breaks used in the "Message to show in popup notification" option at "Super Socializer > General Options" page were not taking effect in the popup notification being displayed at the front-end
...
= 7.11.16 =
* [Bugfix] Social Share counts were not working properly after updating the plugin to version 7.11.14
* [Bugfix] Social Login was not working on multilingual websites (which use querystring parameter to switch language)

= 7.11.15 =
* [Improvement] Message shown in the Twitter login popup (when it was not working) needed to be improved
...
= 7.8.21 =
* [Improvement] Improved social profile data syncing with WooCommerce user data fields
* [Bugfix] New line in "Message to show in popup notification" option at "Super Socializer > General Options" page was breaking some functionality.
